navigator && navigator.connection && (window.networkInfo = navigator.connection,
...
const imageObserver = new IntersectionObserver((e,r)=>{
        ...
        if (e.hasAttribute("data-lazyimg")) {
            ...
            o && window.networkInfo) {
                ...
                r.forEach(({min: e, max: t, regex: r, qMod: a})=>{
                    e <= n && n < t && (r = o.match(r),
                    o = (r && r.length ? r[0] : o) + (a ? "/qt=q:" + Math.round((n - e) / (t - e) * 100) : ""))
                }
                )
            }
            e.srcset = o,
    ...
    e.forEach(e=>{
        if (e.isIntersecting) {
            const t = e.target;
            window.networkInfo && 0 === window.networkInfo.downlink || ([t].concat(Array.from(t.querySelectorAll("[data-lazyimg]"))).forEach(a),
            r.unobserve(t))
        }
    }
    )
  ...
  , backgroundObserver = new IntersectionObserver((e,a)=>{
    e.forEach(e=>{
        if (e.isIntersecting) {
            ...
            r.hasAttribute("data-lazybg") && (t.classList.add(...r.classList),
...
_trfd.push({
    "ap": "IPv2",
    "websiteId": "9f455027-b73c-4901-817e-100880fd9c03",
    "tccl.baseHost": "secureserver.net",
    pd: "2024-01-27T11:02:41.524Z",
    "meta.numWidgets": 12,
    "meta.theme": "layout18",
...
function trackingEnabledForType(t) {
    return !("undefined" != typeof document && "click" === t && !Boolean(window._allowCT)) || (window._allowCT = -1 !== document.cookie.indexOf("cookie_terms_accepted"),
    window._allowCT)
}
    ...
    if (window._trfq && n)
        try {
            var o = n.split(",")
              , d = o[0]
              , r = o[1];
            if (!trackingEnabledForType(r))
                return;
            for (var c = o.splice(2), i = [], l = 0; l < c.length; l += 2)
                i.push([c[l], c[l + 1]]);
            window._trfq.push(["cmdLogEvent", r, d, i])
        } catch (t) {
            window._trfq.push(["cmdLogEvent", "gc_published_site_error", "tccl.published.log", [["error", t.toString()], ["data", n]]])
        }
}
...
var radpack = function() {
    ...
    var _ = (t,s,e)=>n.keys(t.exports).reduce(((r,i)=>{
        ...
        c.forEach((([t,s])=>{
            const e = ((t,s,{name: e, vars: r})=>({
                ...
                entry: t,
                versions: s
            }))(t, s.reduce(((t,{v: s, u: e=null, f: r=null, s: i=[], d: n=[]})=>{
                const o = i.map((t=>a[t]))
                  , c = n.map((t=>a[t]));
    ...
    class R extends class extends Function {
        constructor(t) {
            return super(),
            n.setPrototypeOf(t, new.target.prototype)
        }
    }
    {
        ...
        require(t, s, e) {
            (async()=>{
                try {
                    ...
                    if (await r._(t.filter((t=>!E.includes(t)))),
                    s) {
                        const e = {};
                        s(...t.map((t=>t === u ? r : t === o ? r.require.bind(r) : t === c ? e : r.static(t))))
                    }
                } catch (t) {
                    t.message = `require: ${t.message}`,
                    e && e(t)
                }
            }
            )()
        ...
        J(t, s) {
            const e = $(t, s);
            return e && e.url && (e.url = this.q(e.url)),
            e
        }
        $(t) {
            t = this.C(t);
            ...
            if (!s)
                throw h(`Unable to find export '${t}'`);
            return s
        }
        g(t) {
            const s = new i;
            return t.url && s.add(this.q(t.url)),
            this.j(t).forEach((t=>{
        ...
        A(t) {
            return (t=>{
                ...
                return _(t, ((t,{name: s})=>p(s, t)), (t=>{
                    const {version: s, release: e, caret: r, tilde: i} = (t=>{
                        const [s,e=0,r=0,i=""] = t;
                        return {
                            major: s,
                            minor: e,
        ...
        O(t) {
            ...
            return this.P(e, (()=>{
                const r = e.url;
                let i = [];
                return r ? (i = t.data.statics,
                t.url !== r && this.o.set(this.C(t.id), t)) : this.j(t).forEach((t=>{
                    t.url && i.push(t.id)
                }
                )),
    ...
    const U = new class extends R {
        ...
        S(t, e) {
            return new s(((t,s)=>{
                e.resolve = t,
                e.reject = s,
                a.head.appendChild(n.assign(a.createElement("script"), {
