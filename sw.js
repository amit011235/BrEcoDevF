(()=>{
    ...
    var e = {
            ...
            class i {
                ...
                findMatchingRoute({url: e, sameOrigin: t, request: s, event: a}) {
                    ...
                    for (const r of n) {
                        ...
                        if (i)
                            return n = i,
                            (Array.isArray(n) && 0 === n.length || i.constructor === Object && 0 === Object.keys(i).length || "boolean" == typeof i) && (n = void 0),
                            {
                                route: r,
                                params: n
                            }
                ...
                setDefaultHandler(e, t=a.g) {
                    this._defaultHandlerMap.set(t, (0,
                    n.M)(e))
                }
                setCatchHandler(e) {
            ...
            class l {
                ...
                async cachePut(e, t) {
                    ...
                    const {cacheName: u, matchOptions: d} = this._strategy
                      ...
                      , g = p ? await (0,
                    a.F)(f, n.clone(), ["__WB_REVISION__"], d) : null;
                    try {
                        await f.put(n, p ? l.clone() : l)
                    } catch (e) {
                        if (e instanceof Error)
                            throw "QuotaExceededError" === e.name && await (0,
                            r.Y)(),
                            e
                    }
        ...
        370: (e,t,s)=>{
            ...
            function f(e) {
                ...
                : function(e, ...s) {
                    ...
                    return h.set(a, e.sort ? e.sort() : [e]),
                    p(a)
                }
                ...
                s = e,
                (r || (r = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((e=>s instanceof e)) ? new Proxy(e,d) : e);
                var t, s
            }
            function p(e) {
            ...
            function _(e, t) {
                ...
                const s = t.replace(/FromIndex$/, "")
                  , a = t !== s
                  , n = w.includes(s);
                if (!(s in (a ? IDBIndex : IDBObjectStore).prototype) || !n && !m.includes(s))
                    return;
            ...
            class x {
                ...
                async expireEntries(e, t) {
                    ...
                    for (; a; ) {
                        const s = a.value;
                        s.cacheName === this._cacheName && (e && s.timestamp < e || t && r >= t ? n.push(a.value) : r++),
                        a = await a.continue()
                    }
                    const i = [];
                    for (const e of n)
                        await s.delete(v, e.id),
                        i.push(e.url);
                    return i
                }
                _getId(e) {
                ...
                async getDb() {
                    return this._db || (this._db = await function(e, t, {blocked: s, upgrade: a, blocking: n, terminated: r}={}) {
            ...
            class N {
                constructor(e={}) {
                    ...
                    e.purgeOnQuotaError && (0,
                    k.t)((()=>this.deleteCacheAndMetadata()))
                }
        ...
        522: (e,t,s)=>{
            ...
            class u extends l._ {
                ...
                async _handleFetch(e, t) {
                        ...
                        });
                    {
                        ...
                        n && i && (this._useDefaultCacheabilityPluginIfNeeded(),
                ...
                _useDefaultCacheabilityPluginIfNeeded() {
                    ...
                    for (const [s,a] of this.plugins.entries())
                        a !== u.copyRedirectedCacheableResponsesPlugin && (a === u.defaultPrecacheCacheabilityPlugin && (e = s),
                        a.cacheWillUpdate && t++);
            ...
            u.copyRedirectedCacheableResponsesPlugin = {
                cacheWillUpdate: async({response: e})=>e.redirected ? await (0,
                h.S)(e) : e
            };
            class d {
                ...
                createHandlerBoundToURL(e) {
                    ...
                    if (!t)
                        throw new n.V("non-precached-url",{
                            url: e
                        });
            ...
            class y extends w.A {
                constructor(e, t) {
                    super((({request: s})=>{
                        ...
                        for (const n of function*(e, {ignoreURLParametersMatching: t=[/^utm_/, /^fbclid$/], directoryIndex: s="index.html", cleanURLs: a=!0, urlManipulation: n}={}) {
        ...
        89: (e,t,s)=>{
            ...
            function h(e) {
                (0,
                o.u)().setCatchHandler(e)
            }
            function l(e) {
                (0,
                o.u)().setDefaultHandler(e)
            }
        }
        ,
        362: (e,t,s)=>{
            ...
            class o extends n._ {
                constructor(e={}) {
                    super(e),
                    this.plugins.some((e=>"cacheWillUpdate"in e)) || this.plugins.unshift(c),
            ...
            class l extends n._ {
                ...
                async _handle(e, t) {
                    ...
                    try {
                        ...
                        if (this._networkTimeoutSeconds) {
                            const e = (0,
                            h.V)(1e3 * this._networkTimeoutSeconds);
                            s.push(e)
                        }
    ...
    (()=>{
        var e = s(89)
          ...
          , r = s(522)
          , i = s(634);
        const c = JSON.parse('["bihareconomicdevelopmentfounda\\\\.godaddysites\\\\.com(?:/.*)?/ola/services/.*","bihareconomicdevelopmentfounda\\\\.godaddysites\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://9f455027-b73c-4901-817e-100880fd9c03\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e=>new RegExp(e)))
          , o = JSON.parse('["bihareconomicdevelopmentfounda\\\\.godaddysites\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/9f455027-b73c-4901-817e-100880fd9c03/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/9f455027-b73c-4901-817e-100880fd9c03/feed"]').map((e=>new RegExp(e)))
          , h = JSON.parse('["/","/privacy-policy","/terms-and-conditions","/shop"]').map((e=>({
            url: e,
            revision: "1706353363358"
        })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e=>e.startsWith("bihareconomicdevelopmentfounda.godaddysites.com-"))).map((e=>caches.delete(e))))
            }
            )))
        }
        )),
        ...
        (0,
        e.registerRoute)((({url: e})=>c.some((t=>t.test(e.href)))), new t.NetworkOnly),
        (0,
        r.precache)(h, {
            directoryIndex: null,
            cleanUrls: !1
        ...
        (0,
        e.registerRoute)((({url: e})=>o.some((t=>t.test(e.href)))), new t.NetworkFirst({
        ...
        (0,
        e.registerRoute)((({request: e})=>"style" === e.destination || "script" === e.destination), new t.StaleWhileRevalidate({
        ...
        (0,
        e.registerRoute)((({url: e})=>"https://fonts.googleapis.com" === e.origin), new t.StaleWhileRevalidate({
            cacheName: "google-fonts-stylesheets"
        })),
        (0,
        e.registerRoute)((({url: e})=>"https://fonts.gstatic.com" === e.origin), new t.CacheFirst({
        ...
        (0,
        e.registerRoute)((({request: e})=>"image" === e.destination || "font" === e.destination), new t.CacheFirst({
